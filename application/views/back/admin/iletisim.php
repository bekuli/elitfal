...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
  <h1 class="h2">İletişim İstekleri</h1>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".urltable-content").load("<?=base_url()?>admin/iletisim_list");
        ...
        $(".urltable-content").on("click", "a[data-action]", function(e){
            ...
            if ($(this).attr("data-action") == "delete"){
                ...
                $.ajax({
                    url: '<?=base_url()?>admin/iletisim/' + $(this).parent().attr("data-id") + "/view",
                    contentType: false,
                    processData: false,
                    beforeSend: function(){
        ...
        $("#delete-yes").click(function(){
            $.ajax({
                url: '<?=base_url()?>admin/iletisim/' + $("input[name='delete-id']").attr("value") + "/delete",
                contentType: false,
                processData: false,
                success: function( data){
                    ...
                    if (data == "success")
                    {
                        ...
                        $("#nav a[data-title='iletisim']").click();
                    }else
